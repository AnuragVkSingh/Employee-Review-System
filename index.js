...
const port = 8100; // assigning port, so that I can try and test as this post,
const app = express(); 
...
app.use(session({
    ...
    store: MongoStore.create({
        mongoUrl: 'mongodb+srv://anuragvsingh76:Anurag123@cluster0.5acjvnm.mongodb.net/?retryWrites=true&w=majority',
        autoRemove: 'disabled'
    },
        (err) => {
